  ...
  return <footer className="bg-primary text-primary-foreground py-12">
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          <div>
            <img src="/lovable-uploads/a1be35eb-b948-4087-80bd-7bb9bdcc8420.png" alt="Ponto do Soft" className="h-8 w-auto mb-4 brightness-0 invert" />
        ...
        <div className="border-t border-primary-foreground/20 mt-8 pt-8 text-center">
          <p className="text-sm opacity-75">© 2025 Ponto do Soft. Todos os direitos reservados. | Vacaria - Rio Grande do Sul</p>
        </div>
      </div>
    </footer>;
};
